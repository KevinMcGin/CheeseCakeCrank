...
{
    class ChaseRoom11 : MoveState
    {
        public ChaseRoom11(PoliceState p) : base(p)
        {
        }
        ...
        {
            if (policeState.police.roomOfPlayer.GetRoom() == 10 ||
                policeState.police.roomOfPlayer.GetRoom() == 11 ||
                policeState.police.roomOfPlayer.GetRoom() == 4)
            {
